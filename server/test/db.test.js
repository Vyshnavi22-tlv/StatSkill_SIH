...
console.log('\n[1/6] Testing User Profile & Role Requirements...');
...
console.log('\n[2/6] Testing Competency Graph & Root-Gap Engine...');
...
console.log('\n[3/6] Testing Recommendation Engine & Provider Adapter...');
...
console.log('\n[4/6] Testing AI Assessment Engine & Question Critic...');
...
console.log('\n[5/6] Testing Evidence Model & Explainable Mastery Update...');
...
console.log('\n[6/6] Testing Gamification Engine (XP, Levels, Badges)...');
